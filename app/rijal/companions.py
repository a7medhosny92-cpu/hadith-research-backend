...
RELIABLE_DESPITE_GRAVE: list[str] = [
    "معاذ بن معاذ",           # العنبري قاضي البصرة، ت١٩٦ — ثقة بالإجماع؛ يُذكر في السند بلا «العنبري»
    "حريز بن عثمان",          # الرحبي الحمصي، ت١٦٣ — ثقة ثبت في صحيح البخاري (رُمي بالنصب لا بالكذب)
    "مروان بن الحكم",         # ت٦٥ — روى له الجماعة، حديثه مقبول؛ «كذاب» تحريفٌ من سُمعته السياسية لا جرحٌ روائيّ
    "سفيان بن حسين",          # الواسطي، ت~١٥٦ — ثقة في غير الزهري؛ النسخة «متروك» تكرارٌ مُفسَدُ الدرجة
]
