...
_QAIDA: dict[str, list[tuple[frozenset[str], str]]] = {
    ...
    # إسماعيل بن أبان: الورّاقُ الأزديُّ (ثقة، شيخُ البخاريِّ) vs الغنويُّ الخيّاطُ (متروكٌ كذّبه بعضُهم). لم
    # يَرْوِ البخاريُّ إلا عن الورّاق — «إسماعيل بن أبان عن ابن الغسيل/عيسى بن يونس/ابن المبارك/أبي الأحوص»
    # = الورّاقُ الثقة (مواضعُ صحيح البخاري ٩٣٧ و٤٦٩٩ و٥٧٠٢ و٦٥٣٩ و٦٧٣٥)؛ شيوخُ الغنويِّ لا تُذكَر فتُتركُ مشتركة.
    _f("إسماعيل بن أبان"): [
        (_markers("الغسيل", "عيسى بن يونس", "ابن المبارك", "أبو الأحوص"),
