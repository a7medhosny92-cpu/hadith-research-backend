...
_NAME_CUT = re.compile(
    ...
    r"اسمه|واسمه|واسم|يكنى|المتكلم|المنشأ|"  # «… اسمه يحيى» / «واسم أبيه فيروز» / «يكنى أبا حجية» — a name-note tail
    r"ابن أخت|ابن أخ|أخو|أخت|أخي|"  # a RELATIONAL kin tail naming ANOTHER man («… ابن أخت سعيد بن جبير»،
    #                     «… أخو عمار») — bio, not the subject's name (whole-word, so «أختان» untouched)
...
for _w in _DABT_ADJ:
    _DABT |= {_w, "و" + _w, "ب" + _w, "وب" + _w, "ال" + _w, "وال" + _w, "بال" + _w, "وبال" + _w}
